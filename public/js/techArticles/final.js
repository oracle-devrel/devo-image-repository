...
function changeHeaderLink() {
  ...
  let domain = "https://developer.oracle.com";
...
function showMT() {
  ...
  let freeBTN2 = document.querySelector(
    "#dedd6237-2983-4272-b79d-988ee536c434customComponentDiv > div > div > div > div.ctas > div > div > a"
  ); // Tutorials
  ...
  if (url.includes("/en/") === true) {
    ...
    if (url.includes("/tutorials/")) {
      freeBTN2.href = "https://www.oracle.com/de/cloud/free/";
    } else {
    ...
    if (url.includes("/tutorials/")) {
      freeBTN2.href = "https://www.oracle.com/es/cloud/free/";
    } else {
    ...
    if (url.includes("/tutorials/")) {
      freeBTN2.href = "https://www.oracle.com/fr/cloud/free/";
    } else {
    ...
    if (url.includes("/tutorials/")) {
      freeBTN2.href = "https://www.oracle.com/it/cloud/free/";
    } else {
    ...
    if (url.includes("/tutorials/")) {
      freeBTN2.href = "https://www.oracle.com/ja/cloud/free/";
    } else {
    ...
    if (url.includes("/tutorials/")) {
      freeBTN2.href = "https://www.oracle.com/ko/cloud/free/";
    } else {
    ...
    if (url.includes("/tutorials/")) {
      freeBTN2.href = "https://www.oracle.com/pt-BR/cloud/free/";
    } else {
    ...
    if (url.includes("/tutorials/")) {
      freeBTN2.href = "https://www.oracle.com/zh/cloud/free/";
    } else {
